...
pdf_documents = [('index', u'rst2pdf', u'Sample rst2pdf doc', u'COOP'),]

# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = 'openteadoc'
...
latex_documents = [
    (master_doc, 'opentea.tex', 'Opentea Documentation',
     'Team COOP', 'manual'),
]
...
man_pages = [
    (master_doc, 'opentea', 'Opentea Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opentea', 'Opentea Documentation',
     author, 'Opentea', 'One line description of project.',
     'Miscellaneous'),
]
